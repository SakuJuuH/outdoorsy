...
4.  After deleting the default key, name you new API Key and click on the **"Create New Key"** button.
...
3.  Add the following line to your `local.properties` file, pasting your API key after the equals sign: `CURRENCY_API_KEY=YOUR_API_KEY_HERE`
